...
TCHAR *szTitle			= _T("ScreenShottr");		// �^�C�g�� �o�[�̃e�L�X�g
TCHAR *szWindowClass	= _T("SCREENSHOTTRWIN");	// ���C�� �E�B���h�E �N���X��
TCHAR *szWindowClassL	= _T("SCREENSHOTTRWINL");	// ���C���[ �E�B���h�E �N���X��
HWND hLayerWnd;
